...
const Button = React.forwardRef<HTMLButtonElement, Props>(
  (
    ...
    const colorClasses = {
      default: {
        contained: "bg-zinc-300 text-zinc-900 shadow-sm dark:bg-zinc-700 dark:text-zinc-200",
        outlined: "border border-zinc-200 text-zinc-900 shadow-sm dark:border-zinc-600 dark:text-zinc-200",
